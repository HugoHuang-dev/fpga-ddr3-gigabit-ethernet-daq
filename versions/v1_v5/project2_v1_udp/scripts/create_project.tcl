...
create_project project2_v1_udp $build_dir -part xc7a35tfgg484-2 -force
set_property target_language Verilog [current_project]
set_property simulator_language Mixed [current_project]

add_files -norecurse [glob [file join $root_dir rtl vendor net21 *.v]]
add_files -norecurse [file join $root_dir rtl udp_v1_app.v]
add_files -norecurse [file join $root_dir rtl project2_v1_top.v]
...
add_files -fileset sim_1 -norecurse [file join $root_dir sim tb_udp_v1_app.v]

set_property top project2_v1_top [get_filesets sources_1]
set_property top tb_udp_v1_app [get_filesets sim_1]
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1

generate_target all [get_ips]
export_ip_user_files -of_objects [get_ips] -no_script -sync -force -quiet
puts "PROJECT_CREATED: [file join $build_dir project2_v1_udp.xpr]"
