...
// File    : project2_v1_top.v
// Module  : project2_v1_top
// Created : 2026-07-19
// Revised : 2026-09-19
...
(* mark_debug = "true" *) wire [31:0] echo_packet_count;
(* mark_debug = "true" *) wire [31:0] beacon_packet_count;
(* mark_debug = "true" *) wire [31:0] rx_drop_count;
...
// Hold the external PHY in reset for 20 ms after the clocks are stable.
...
udp_v1_app #(
    .BEACON_INTERVAL_CYCLES (125_000_000)
) u_udp_v1_app (
    .clk                 (clk_125m),
    .reset               (reset),
    .app_rx_data_vld     (app_rx_data_vld),
    ...
    .app_tx_length       (app_tx_length),
    .app_tx_ready        (app_tx_ready),
    .echo_packet_count   (echo_packet_count),
    .beacon_packet_count (beacon_packet_count),
