...
create_project project2_v7_uart_control $build_dir -part xc7a35tfgg484-2 -force
...
set_property top project2_v7_top [get_filesets sources_1]
set_property top tb_v7_uart_control [get_filesets sim_1]
...
puts "PROJECT_CREATED: [file join $build_dir project2_v7_uart_control.xpr]"
