...
STOP must return `TYPE=0x84 SEQ=8 RESULT=OK`. Apply the common pass criteria and preserve the windows plus [Gate 1 JSON](results/v7_gate1_512B_25M_60s.json).
...
[Gate 1](results/v7_gate1_512B_25M_60s.json),
[Gate 2A](results/v7_gate2_256B_25M_10s.json),
[Gate 2B](results/v7_gate2_1024B_25M_10s.json),
[Gate 3](results/v7_gate3_1024B_12M5_10s.json),
[Gate 4](results/v7_gate4_finite_1Mwords_256B.json),
[Gate 6](results/v7_gate6_1024B_max_60s.json), and
[Gate 7](results/v7_gate7_1024B_max_300s.json).
