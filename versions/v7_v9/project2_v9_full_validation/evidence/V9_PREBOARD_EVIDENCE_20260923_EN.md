...
| --- | --- | --- |
| ModelSim DE-64 10.6c | 3/3 PASS | [`modelsim/MODELSIM_V9_SUMMARY.md`](modelsim/MODELSIM_V9_SUMMARY.md) and three transcripts |
| PC Windows RIO self-test | 10/10 PASS | [`modelsim/udp_v9_monitor_self_test.log`](modelsim/udp_v9_monitor_self_test.log) |
| Vivado 2018.3 routed design | PASS | [`vivado/timing_summary.rpt`](vivado/timing_summary.rpt), `utilization.rpt`, `drc.rpt`, `bus_skew.rpt` |
