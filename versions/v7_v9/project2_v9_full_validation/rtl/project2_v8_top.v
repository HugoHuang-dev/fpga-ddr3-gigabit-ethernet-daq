...
// File    : project2_v8_top.v
// Module  : project2_v8_top
// Created : 2026-09-08
// Revised : 2026-09-23
...
module project2_v8_top (
    ...
    v8_uart_control #(.CLK_HZ(125000000),.BAUD(115200)) u_uart_control(
    ...
    udp_v8_tx_fifo_packetizer #(.BURST_BYTES(BURST_BYTES),.FIFO_BURSTS(8),
