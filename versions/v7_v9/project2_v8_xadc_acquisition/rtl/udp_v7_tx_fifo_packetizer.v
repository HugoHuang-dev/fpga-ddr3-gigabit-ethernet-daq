...
// File    : udp_v7_tx_fifo_packetizer.v
// Module  : udp_v7_tx_fifo_packetizer
// Created : 2026-09-02
// Revised : 2026-09-22
...
// V7 keeps DDR transfers fixed at BURST_BYTES but can divide each complete
// burst into 256, 512 or 1024-byte UDP payloads. Ring space is released when
// the complete DDR burst enters this FIFO, exactly as in V6.
module udp_v7_tx_fifo_packetizer #(
