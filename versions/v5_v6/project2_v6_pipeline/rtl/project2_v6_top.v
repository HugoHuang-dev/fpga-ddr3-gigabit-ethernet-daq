...
// File    : project2_v6_top.v
// Module  : project2_v6_top
// Created : 2026-08-25
// Revised : 2026-09-22
...
module project2_v6_top (
    ...
    prbs16_stream_source #(.PRBS_SEED(16'hACE1)) u_source(
        .clk(clk_125m),.reset(reset),.enable(start_latched && source_run),
    ...
    udp_v6_tx_fifo_packetizer #(.DATA_BYTES(BURST_BYTES),.FIFO_PACKETS(8),
