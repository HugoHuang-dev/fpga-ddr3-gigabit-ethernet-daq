...
create_project project2_v6_pipeline $build_dir -part xc7a35tfgg484-2 -force
...
add_files -fileset sim_1 -norecurse [file join $root_dir sim tb_v6_pipeline.v]
set_property top project2_v6_top [get_filesets sources_1]
set_property top tb_v6_pipeline [get_filesets sim_1]
...
puts "PROJECT_CREATED: [file join $build_dir project2_v6_pipeline.xpr]"
