...
open_project [file join $root_dir build project2_v6_pipeline.xpr]
reset_run synth_1
...
file copy -force [get_property DIRECTORY [current_run]]/project2_v6_top.bit [file join $root_dir project2_v6_top.bit]
write_debug_probes -force [file join $root_dir project2_v6_top.ltx]
puts "BITSTREAM_READY: [file join $root_dir project2_v6_top.bit]"
close_project
