...
set_property -dict [list CONFIG.C_NUM_OF_PROBES {41} CONFIG.C_DATA_DEPTH {2048} \
    ...
    CONFIG.C_PROBE36_WIDTH {1} CONFIG.C_PROBE37_WIDTH {1} CONFIG.C_PROBE38_WIDTH {1} \
    CONFIG.C_PROBE39_WIDTH {1} CONFIG.C_PROBE40_WIDTH {1}] [get_ips ila_v5]
