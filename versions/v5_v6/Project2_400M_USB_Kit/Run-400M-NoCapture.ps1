...
if (-not $principal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    throw 'Right-click 01_Run_400M_60s_NoCapture.cmd and choose Run as administrator.'
}
...
$rule = 'Project2_400M_' + [guid]::NewGuid().ToString('N')
$ruleAdded = $false
$receiverExitCode = -1
...
try {
    ...
    Write-Host "This is the controlled 400 Mb/s NO-CAPTURE test for $DurationSeconds seconds."
    ...
    Write-Host 'Confirm PktMon is stopped. Program fpga\project2_v5_400m.bit with the matching LTX.'
